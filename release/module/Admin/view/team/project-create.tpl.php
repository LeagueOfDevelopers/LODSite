...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" >
     <form class="form-horizontal" method="POST"  action="/adminium/createProject"  style = "margin:0px;padding:0px;">
 <h1 class="page-header">Создать проект</h1>
            ...
            <div class="form-group" id="login_field">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-tag"></span></span>
                        <input type="text" class="form-control" name="name_of_order" value="" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" id="login_field">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-tag"></span></span>
                        <input type="text" class="form-control" name="git_hub" value="" />
                    </div>
                </div>
            </div>
            <div class="form-group" id="login_field">
