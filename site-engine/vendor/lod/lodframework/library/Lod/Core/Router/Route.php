...
class Route extends AbstractRoute {
    ...
    public function isMobileBrowser($type) {
        return $type != 200;
    }

    public function setCookie($name, $val, $exp, $path = null, $domain = null, $secure = null, $httponly = null) {
        setcookie($name, $val, $exp, $path, $domain, $secure, $httponly);
    }
}